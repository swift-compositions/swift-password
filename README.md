...
[![CI](https://github.com/swift-compositions/swift-password/workflows/CI/badge.svg)](https://github.com/swift-compositions/swift-password/actions/workflows/ci.yml)
...
```swift
dependencies: [
    .package(url: "https://github.com/swift-compositions/swift-password.git", from: "0.0.1")
]
```
...
- [swift-translating](https://github.com/swift-compositions/swift-translating): A Swift package for inline translations.
